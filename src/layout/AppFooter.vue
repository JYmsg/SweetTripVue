            ...
            <div class="row align-items-center justify-content-md-between">
                <div class="col-md-6">
                    <div class="copyright">&copy;
                        2023
                        <a href="https://www.creative-tim.com" target="_blank" rel="noopener">JUNGEUN</a> & <a href="https://www.binarcode.com" target="_blank" rel="noopener">YUJIN</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <ul class="nav nav-footer justify-content-end">
                        ...
                        <li class="nav-item">
                            <a href="https://github.com/creativetimofficial/argon-design-system/blob/master/LICENSE.md"
                               class="nav-link" target="_blank" rel="noopener">SSAFY</a>
                        </li>
                    </ul>
                </div>
            </div>
